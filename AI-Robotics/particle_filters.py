# -*- coding: utf-8 -*-
"""
Created on Thu Nov 10 08:18:55 2016
...
Z = myrobot.sense()
# Create particles - Initialize randomly
N = 1000
p = []
for i in range(N):
        x = robot()
...
init_error = eval(myrobot,p)
print(init_error)
## Assign importance weight to the particles
cycles = 10
