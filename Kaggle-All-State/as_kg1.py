# -*- coding: utf-8 -*-
"""
Created on Thu Oct 13 15:54:25 2016
...
## Lets plot to see what has happened
import seaborn as sns
sns.set(style="whitegrid", color_codes=True)
sel_feature =  'cont3'
sns.distplot(train_test[sel_feature], kde = False)
sns.distplot(train[sel_feature], kde = False)
...
train_test['cat112'][:10]
# Split back into test and train
x_train = train_test.iloc[:ntrain, :]
x_test = train_test.iloc[ntrain:, :]


## Why are we scaling the data at this point??
